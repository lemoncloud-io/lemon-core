...
internals.regexMap = _.reduce(internals.actionWords, function (result: any, key: any) {
...
export const parse = function (str: any) {
  return _.reduce(internals.actionWords, function (result: any, actionWord: any) {
...
export const serializeUpdateExpression = function (schema: any, item: any) {
  ...
  memo.expressions = _.reduce(internals.actionWords, function (result: any, key: any) {
    result[key] = [];

    return result;
  }, {});

  const result = _.reduce(data, function (result: any, value: any, key: any) {
    var valueKey = ':' + key;
    var nameKey = '#' + key;
...
export const stringify = function (expressions: any) {
  return _.reduce(expressions, function (result: any, value: any, key: any) {
    if(!_.isEmpty(value)) {
      if(_.isArray(value)) {
...
internals.buildInFilterExpression = function (key: any, existingValueNames: any, values: any) {
  ...
  var attributeValues = _.reduce(values, function(result: any, val: any) {
