...
// Keep test runner access indirect (via globalThis) — avoids a hard import of Vitest,
// so this file stays portable to consumers that copy `cores/` without vitest installed.
