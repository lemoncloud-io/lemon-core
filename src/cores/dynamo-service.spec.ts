...
export const instance = () => {
    ...
    const dummy: DynamoService<MyModel> = new DummyDynamoService<MyModel>('dummy-dynamo-data.yml', options);
...
describe('DynamoService', () => {
    ...
    it('should pass basic CRUD w/ dummy', async done => {
        ...
        //! check dummy data.
        expect2(await dummy.hello()).toEqual('dummy-dynamo-service:DynamoTest');
