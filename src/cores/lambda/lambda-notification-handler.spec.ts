...
describe('LambdaNotificationHandler', () => {
    ...
    it('should pass sns subscription', async () => {
        ...
        expect2(data, 'param').toEqual({
            param: {
                snsMessageId: 'ef9765be-a053-40d8-907b-4a212b8a8b6e',
        ...
        expect2(data, 'context').toEqual({
            context: {
                accountId: '796730245826',
                clientIp: '54.239.110.00',
                domain: '9tdk25wjpd.execute-api.ap-northeast-2.amazonaws.com',
                requestId: '3e55dcae-523a-48ae-861b-b776208c4b70',
            },
        });
    ...
    it('should pass notification w/ raw-delivery ', async () => {
        const { lambda, service } = instance();
        ...
        expect2(data, 'param').toEqual({
            param: {
                snsMessageId: 'ce739c18-f6bf-5d16-8818-ca6a56522dfa',
                snsMessageType: 'Notification',
                snsTopicArn: 'arn:aws:sns:ap-northeast-2:796730245826:lemon-todaq-out',
                snsSubscriptionArn:
                    'arn:aws:sns:ap-northeast-2:796730245826:lemon-todaq-out:691a3ee3-5e1b-4b44-b0c0-ad1cd6a5b87f',
            },
        });
        expect2(data, 'context').toEqual({
            context: {
                ...
                clientIp: '54.239.110.00',
                domain: '9tdk25wjpd.execute-api.ap-northeast-2.amazonaws.com',
                requestId: '3e7f3eff-f666-4e4f-9d47-590418938684',
            },
        });
        expect2(typeof data.body).toEqual('object');
    ...
    //* handle for notification
    it('should pass notification w/ no-raw ', async () => {
        const { lambda, service } = instance();
        ...
        const snsSubscriptionArn =
            'arn:aws:sns:ap-northeast-2:796730245826:lemon-todaq-out:407826b6-3138-457c-a48b-ddc9f5aba2e8';
        const snsTopicArn = 'arn:aws:sns:ap-northeast-2:796730245826:lemon-todaq-out';
        ...
        expect2(data, 'context').toEqual({
            context: {
                ...
                clientIp: '54.239.110.00',
                domain: '9tdk25wjpd.execute-api.ap-northeast-2.amazonaws.com',
                requestId: 'a11b1ddd-4987-46f4-9fdd-c5ddc88e9705',
            },
        });
        expect2(typeof data.body).toEqual('object');
        expect2(data.body, '').toEqual({ hello: 'world' });
