...
describe('TestHelper', () => {
    ...
    //* test _it()
    _it('should ignore this test', async () => {});

    //* test environ()
    it('should pass environ helper', async () => {
    ...
    //* test _it()
    it('should helper functions', async () => {
    ...
    it('should pass fianlly()', async () => {
        ...
        expect2(await func('hello', errs).catch(GETERR)).toEqual({
            name: 'hello',
            i: undefined,
            error: 'err@mid - hello',
        });
        ...
        expect2(await func('hello', errs, echo).catch(GETERR)).toEqual({
            name: 'hello',
            i: undefined,
            error: 'err@mid - hello',
        });
